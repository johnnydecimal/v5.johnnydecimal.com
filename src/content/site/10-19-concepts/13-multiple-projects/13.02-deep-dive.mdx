...
It is the issue which causes the most confusion, so I will go in to a lot more detail here. This page is quite long, so here's a table of contents to help you get around.
...
- [Definitions](#definitions)
  - [Project](#project)
  - [System](#system)
  - finish me when the article is reviewed
...
It should be clear that we require a further level of identification to allow us to differentiate projects.
...
I've said that `A00` is the 'first project' here just to get the point across. You should be more imaginative with your project identifiers as it will help you to remember them.
...
Some suggestions, which you should adapt to the way your own brain works.
...
Similarly, play with the numbers. Here are all of the current projects in my life and the rationale behind their identifiers.
...
- `P01`: my [entire personal life](https://forum.johnnydecimal.com/t/my-personal-system/412) for a decade.
  ...
  - I tested three digits as a project identifier, so this was `101` for a while.
...
- `P04`: our [Learn with Lucy](https://www.learnwithlucy.rocks/courses/excel) Excel course.
  - A personal project, and in my old scheme (now defunct) this was the 4th project.
  - (It's really good! You should learn Excel.)
- `L43`: my previous job.
  - Which I quit to focus on Johnny.Decimal! Please [support me](/00-09-site-administration/02-support-the-site/02.01-sponsor-me/). ;-)
...
Whereas previously our IDs were of the form `11.01`, which we [refer to in the abstract](/10-19-concepts/12-advanced/12.05-acid-notation/) as `AC.ID`, they have now expanded and are now in the range:
...
If you ever come close to 'using up' your project identifiers then I think you've probably done it wrong.
...
And now any file that you have cause to email has its identifier embedded. I've used this to [find a five-year-old file in a matter of seconds](https://forum.johnnydecimal.com/t/numbers-in-file-names-now-officially-endorsed/398).
...
The power of your [index](/10-19-concepts/11-core/11.05-the-index/), which for me is also my notes system, is its ability to instantly and without ambiguity find any item.
...
# An exception: systems across domains

When you have **single-project systems** each in their own domain, **you should not need to use a multiple project system.**
...
<Footnote
  footnotes={[
    "To be clear, you <em>may</em> use any project code anywhere. Just because you use <code>L</code> for a project in one domain does not preclude you from also using it in another domain. But it might be neater to do so, and it will certainly help your brain.",
  ]}
/>
