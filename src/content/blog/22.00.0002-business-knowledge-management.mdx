...
But whenever I've seen anyone in this role their focus tends to be on the organisations data*bases*. That SFIA description talks about your 'knowledge management database' but the word 'file' doesn't appear once.
...
But that's no excuse to neglect it. Your internal knowledge databases may be amazing<FootRef n={1} /> but that's only part of the picture.
